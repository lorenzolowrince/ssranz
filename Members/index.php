    ...
    <body>
          ...
          <a href="../Import/index.php" class="w3-bar-item w3-button">
            ...
            <p class="w3-red w3-small"> 
             ...
             <?php  if (isset($_SESSION['username'])) : ?> 
                <a href="../index.php?logout='1'" id="logout" name="logout" class="w3-large w3-bar-item w3-button"><i class="fa fa-sign-out"></i> LOG OUT </a>
            <?php endif ?> 
        </div>
        <!-- Sidebar -->
        ...
        <div style="margin-left:15%">
            ...
            <div class="w3-bar w3-teal">
                <div class="w3-bar-item"> MEMBERS </div>
                        ...
                        while($d = mysqli_fetch_array($data)){
                            ...
                            <tr class="item">
                                ...
                                <td>
                                    ...
                                    <a href="preview.php?id=<?php echo $d['id']; ?>"> <button type='button'>Preview</button></a>
