...
<html lang="en">
    ...
    <body>
        ...
        <div class="w3-sidebar w3-light-grey w3-bar-block" style="width:15%">
          ...
          <a href="index.php" class="w3-bar-item w3-button">Diary</a>
        ...
        <div style="margin-left:15%">
            ...
            <div class="w3-bar w3-teal">
                <div class="w3-bar-item"> DIARY </div>
            ...
            <div class="w3-row"> 
                <div class="w3-container">
                    <a href="create.php"> <button class="w3-button w3-black"> Write New </button> </a>
                </div>
            </div>
            ...
            <div class="w3-row"> 
                <div class="w3-container">
                    <input oninput="w3.filterHTML('#id01', '.item', this.value)" class="w3-input" type="text" placeholder="Search for title/label/month/year">
                </div>
            </div>
                    ...
                    <?php
                        ...
                        while($d = mysqli_fetch_array($data)){
                            ...
                            <tr class="item">
                                ...
                                <td>
                                    <a href="edit.php?id=<?php echo $d['id']; ?>"> <button type='button'>Edit</button></a>
                                    
                                    <a href="view.php?id=<?php echo $d['id']; ?>"> <button type='button'>View</button></a>
