    ...
    <body>
        ...
        <div style="margin-left:15%">
            ...
            <div class="w3-bar w3-teal">
                <div class="w3-bar-item">EDIT DIARY</div>
            ...
            <form method="post" action="php_action/update.php" class="w3-container w3-padding-24" enctype="multipart/form-data">      
                ...
                <div class="w3-row w3-container w3-margin w3-padding-small">
                    ...
                    <table class="w3-third table w3-large">
                        <tr>
                            ...
                            <td>
                                <input class="w3-input" type="text" id="title" name="title" value="<?php echo $data['title']  ?>">
                            </td>
                        </tr>
                        <tr>
                            <td class="w3-center"> Label </td>
                            <td>
                                <input class="w3-input" type="text" id="label" name="label" value="<?php echo $data['label']  ?>">
                            </td>
                        </tr>
                        <tr>
                ...
                <div class="w3-row w3-container">
                    ...
                    <div class="w3-container w3-center">
                      <p><textarea name="note" id="note" cols="100" rows="25"><?php echo htmlspecialchars($data['note']);?> </textarea></p>
                    </div>
